...
### M8 — Provider Resilience
| ID | Task | Est (h) | Depends |
|----|------|--------|---------|
| T-801 | OpenRouter adapter (`openrouter.py`, `_openai_compat.py` extraction) + golden-fixture tests | 5 | T-201 |
| T-802 | app.py/config.py/settings_view.py wiring: third provider, key row, first-run banner fix | 3 | T-801, T-209 |
